...
## 2. Download the processed data files (UMI tables) from Gene Expression Omnibus (accession GSE135429) into a folder called "processed_data_files" within "EhVEmiliania_scRNAseq".
...
## retain cells with ≥ 10 viral UMIs in the order of infection states
